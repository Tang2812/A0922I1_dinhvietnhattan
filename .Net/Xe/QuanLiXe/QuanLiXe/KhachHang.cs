...
namespace QuanLiXe
{
    class KhachHang : Nguoi
    {
        ...
        public override void nhap()
        {
            ...
            Console.WriteLine("Nhap vao ma KH: ");
            this.maKH = Console.ReadLine();
            Console.WriteLine("Nhap vao Han bang lai: ");
            this.hanBangLai = DateTime.Parse(Console.ReadLine());
        ...
        public override void xuat()
        {
            ...
            Console.WriteLine(this.maKH);
            Console.WriteLine(this.hanBangLai);
