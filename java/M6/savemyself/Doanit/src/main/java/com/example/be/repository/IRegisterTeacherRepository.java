...
public interface IRegisterTeacherRepository extends JpaRepository<InfoTopicRegister, Integer> {
    @Query(value = "SELECT t.teacher_id teacherId, t.name as name, t.address, t.avatar, t.date_of_birth as dateOfBirth, t.email, t.phone, t.gender, f.name as facultyName, d.name as degreeName " +
            "FROM teacher t " +
