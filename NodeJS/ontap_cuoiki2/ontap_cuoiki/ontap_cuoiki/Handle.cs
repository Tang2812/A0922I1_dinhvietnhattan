...
namespace ontap_cuoiki
{
    public class Handle
    {
        ...
        private void ConnectData()
        {
            ...
            connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Thương mại điện tử\ontap_cuoiki2\ontap_cuoiki\ontap_cuoiki\App_Data\Ontap.mdf;Integrated Security=True");
